...
for state, data in state_file.items():
    ...
    state_info_data_list.append(html.H3(children=[
    ...
    state_info_data_list.append(html.Div(children=[
        ...
        html.Table(children=[
            html.Tr(children=[
                html.Td(children="Total Cases", className="state-stat-title state-stat-row"),
                html.Td(children=f": {state_cases:,}", className="state-stat-num state-stat-row")
            ]),
            html.Tr(children=[
                html.Td(children="Total Deaths", className="state-stat-title state-stat-row"),
                html.Td(children=f": {state_death:,}", className="state-stat-num state-stat-row")
            ]),
            html.Tr(children=[
                html.Td(children="Avg Mortality Rate", className="state-stat-title state-stat-row"),
                html.Td(children=f": {state_mrate:,}%", className="state-stat-num state-stat-row")
            ]),
            html.Tr(children=[
                html.Td(children="Avg Mortality Rate (minus Senior deaths)"),
    ...
    state_info_data_list.append(html.H4(children="Age Statistics (Ungrouped)"))
    ...
    state_info_data_list.append(html.H3(children="Race Statistics (All)"))
    state_info_data_list.append(html.Div([
...
app.layout = html.Div(children=[
    html.Div(id="container", className="header", children=[
        ...
        html.Div(children=state_info_data_list, className="data-container"),
